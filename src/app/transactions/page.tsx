...
import GeneralContainer from "@/components/layout/general-container";
  ...
  return (
    <div className="transaction-item mb-2 flex w-full items-center gap-3 rounded-[20px] bg-white p-4">
      ...
      <div className="transaction-item__details text-dark1">
        ...
        <div className="text-xs">{displayDate(new Date(transaction.date))}</div>
      </div>
...
export default function TransactionsPage() {
  ...
  const mainContent = transactionsData.length ? (
    <>
    ...
    <div className="grid h-full w-full place-items-center">
      <div className="pb-20 text-center">
        ...
        <p className="px-12 text-sm font-medium text-dark2">
          Enter your first transaction by tapping the add transaction button
          below!
        </p>
      </div>
    </div>
